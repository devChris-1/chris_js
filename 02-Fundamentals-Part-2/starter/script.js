...
console.log(yearsUntilRetirement(1995, 'Chris'));
*/
/*
...
yearsUntilRetirement(1991, 'chris');
...
const bothAvg = dolphinsAvg === koalasAvg;
if (dolphinsAvg > koalasAvg && dolphinsAvg > 100) {
    console.log('Dolphins win the Trophy!');
} else if (koalasAvg > dolphinsAvg && koalasAvg > 100) {
    console.log('Koalas win the Trophy !');
} else if (dolphinsAvg === koalasAvg && bothAvg >= 100) {
...
console.log(`The bill was ${bill}, the tip was ${tip}, and the total value ${billValue}`);
...
// for loop keeps runnning while conditions are TRUE
/*
...
2.  calculate the average, divide the sum you calculated before by the length of the array (because that's the number of elements).
